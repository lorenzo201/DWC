          ...
          /*el email tiene un formato de email válido y coincide con el email repetido.*/
            ...
            if(email != emailRepe){
              ...
              if (tipoPago != "efectivo" && tipoPago != "tarjeta"){
                ...
                /*modificar el lugar de destino del formulario en función de la sección
                escogida por el usuario (tendrás que crear una página html para cada
                sección con un titular y una foto).*/
