var productos = [
  ...
  {
    nombre:'Chocolate',
    descripcion: 'Chocolate negro ,muy saludable',
    foto:'https://st1.tudespensa.com/rep/67fd/imagenes/41598/109/chocolate-negro-70--cacao-lacasa-tableta-150-gr.jpg',
    precio: 1.30,
    vegano: true
  },
  {
    nombre:'tazas',
    descripcion: 'tazas de cafe,pack de 4',
    foto:'https://www.tazasoriginales.net/wp-content/uploads/2017/03/Coffee-Style-Pack-de-4-tazas-4-platos-para-caf%C3%A9-expresso-300x300.jpg',
    precio: 3.30,
    vegano: true
  }
